  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        className={styles.toolbarCodeBlockLanguageSelectTrigger}
        useEmitterValues={useEmitterValues}
      />
      <SelectContent className={styles.toolbarCodeBlockLanguageSelectContent} useEmitterValues={useEmitterValues}>
